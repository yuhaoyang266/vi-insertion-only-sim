...
def test_sprint2_paper_docs_reference_current_frozen_outputs() -> None:
    ...
    assert "three_dof_benchmark_paper9suite_full5profile_bc32x32_stage3_20260412.json" in checked_text
    assert "three_dof_statistics_report_stage3_20260412.json" in checked_text
    assert "table_3dof_paper_benchmark_stage3_20260412" in checked_text
