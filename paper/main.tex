...
show lower contact load and work for variable stiffness. The claim is benchmark-local and matched-demonstration bounded, not a general robotics or teacher-independent algorithm-ranking result.
\end{abstract}
...
robust learned interface under the matched-demonstration setup rather than a diffuse claim of
