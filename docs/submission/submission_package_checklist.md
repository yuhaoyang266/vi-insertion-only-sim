...
- Teacher metadata serialization coverage passes in `tests/three_dof/test_three_dof_teacher_training.py`.
...
- `docs/submission/cover_letter_draft.md` is already staged into `editor_materials/`; any venue-specific
